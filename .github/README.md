...
### Postman Environment: [LINK](https://www.postman.com/admiral-piett/workspace/public-collections/environment/4714469-b99a29bb-82ec-4ede-b926-41207e0c9398?action=share&source=copy-link&creator=4714469)
### Postman Collection: [LINK](https://www.postman.com/admiral-piett/workspace/public-collections/collection/4714469-6428be8d-a507-43dc-9848-8109b7ff695d?action=share&source=copy-link&creator=4714469)

You can test that your installation is working correctly in one of two ways:

 1.  Using the postman collection, use this [link to import it](https://www.postman.com/admiral-piett/workspace/public-collections/collection/4714469-6428be8d-a507-43dc-9848-8109b7ff695d?action=share&source=copy-link&creator=4714469).  As well the Environment variable for the collection should be set as follows:  URL = http://localhost:4100/.
